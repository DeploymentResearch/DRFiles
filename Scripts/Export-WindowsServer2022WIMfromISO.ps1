...
# Please note that editions in evaluation media are named differently, for example: Windows Server 2022 Standard Evaluation (Desktop Experience)
...
$Edition = "Windows Server 2022 Standard (Desktop Experience)" # Edition to export
