...
-- and v_TaskSequencePackage.Name = 'Windows 11 Enterprise x64 22H2 MDM BranchCache'
--where v_TaskSequencePackage.Name like 'pre%'
-- and v_R_System.Name0 like '2PS-R%-001'
