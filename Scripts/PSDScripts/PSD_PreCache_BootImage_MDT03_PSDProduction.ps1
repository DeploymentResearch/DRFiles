<#
.SYNOPSIS
    Pre-caches the PSD boot image into the local BranchCache cache.
.DESCRIPTION
    Downloads the boot image WIM with BITS so the content is present in the BranchCache data
    cache before the deployment window opens.
.LINK
