<#
.SYNOPSIS
    Adds files to a boot image inside an ISO and rebuilds the ISO.
.DESCRIPTION
    Extracts the ISO, mounts the boot WIM, copies the extra files in, dismounts with changes
    saved, and generates a new bootable ISO with oscdimg.
.LINK
