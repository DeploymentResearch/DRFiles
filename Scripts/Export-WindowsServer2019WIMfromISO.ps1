...
$Edition = "Windows Server 2019 Standard (Desktop Experience)" # Edition to export. Note: If using Evaluation Media, use: Windows Server 2019 Standard Evaluation (Desktop Experience)
