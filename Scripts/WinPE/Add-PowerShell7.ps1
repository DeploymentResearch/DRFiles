...
# Settings
$PowerShell7File = "C:\Setup\PowerShell-7.4.13-win-x64.zip"
...
# Avoid PowerShell telling you about new versions (Thank you Michael Niehaus for this tip)
$Result = New-ItemProperty -Path $RegistryKey -Name "POWERSHELL_UPDATECHECK" -Value "LTS" -Force | Out-Null
