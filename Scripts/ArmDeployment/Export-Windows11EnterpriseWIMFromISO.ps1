<#
.SYNOPSIS
    Extracts the Windows 11 Enterprise ARM64 index from a Windows 11 ISO.
.DESCRIPTION
...
# General parameteers
$ISO = "C:\ISO\Windows 11 Business Editions arm64 22H2.iso" # Path to Windows 11 media
$WIMPath = "C:\WIM" # Target folder for extracted WIM file containing Windows 11 Enterprise only
$WIMFile = "$WIMPath\W11-ARM64-22H2-Enterprise.wim" # Exported WIM File
