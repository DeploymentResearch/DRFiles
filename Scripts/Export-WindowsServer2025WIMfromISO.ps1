<#
.SYNOPSIS
    Extracts the Windows Server 2025 Standard index from a Windows Server ISO.
.DESCRIPTION
...
# Script to extract the Windows Server 2025 Standard index from a Windows Server 2025 media.
# Update line 5 - 8 to match your environment

# General parameteers
$ISO = "F:\ISO\Microsoft\Windows Server 2025 (Updated Dec 2024).iso" # Path to Windows Server 2025 media
$WIMPath = "C:\Ref" # Target folder for extracted WIM file containing Windows Server 2025 Standard only
$WIMFile = "$WIMPath\REFWS2025-001.wim" # Exported WIM File
$Edition = "Windows Server 2025 Standard (Desktop Experience)" # Edition to export. Note: If using Evaluation Media, use: Windows Server 2025 Standard Evaluation (Desktop Experience)
