<#
.SYNOPSIS
    Creates a Windows Server 2019 reference image using DISM.
.DESCRIPTION
    Mounts the operating system WIM, applies updates, runs component cleanup, and exports the
    result. Use DISM from the latest Windows ADK when servicing a newer build.
.LINK
