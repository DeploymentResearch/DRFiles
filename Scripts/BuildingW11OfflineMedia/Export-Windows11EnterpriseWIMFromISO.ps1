...
# General parameteers
$ISO = "E:\ISO\Windows 11 Business Editions x64 23H2 (updated July 2024).iso" # Path to Windows 11 media
$WIMPath = "E:\WIM" # Target folder for extracted WIM file containing Windows 10 Enterprise only
$WIMFile = "$WIMPath\W11-X64-23H2-Enterprise.wim" # Exported WIM File
